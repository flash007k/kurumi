...
PM_START_TEXT = """
Hi {}, my name is Giorno Giovanna! 
I am an Anime themed group management bot. I will use my Gold Experience and protect your group. You can find my list of available commands with /help.
"""

HELP_STRINGS = """
Giorno is here! 
I Use My Stand Abilities To Help Admins To Manage Their Groups! 
...
For all command use / [or](https://telegra.ph/file/bbe217f99ef4585432d51.png) ! 
""".format(
    dispatcher.bot.first_name, ""
    if not ALLOW_EXCL else "\nAll commands can either be used with / or !.\nKindly use ! for commands if / is not working\n")

TOKISAKI_IMG = "https://telegra.ph/file/ad32ae1da39cfdbe89bd6.jpg"
KURUMI_IMG = "https://telegra.ph/file/ad2700d5cb83fae40784f.mp4"
...
def start(update: Update, context: CallbackContext):
    ...
    if update.effective_chat.type == "private":
        if len(args) >= 1:
            ...
            update.effective_message.reply_photo(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [[
                        InlineKeyboardButton(
                            text="☑️ Add Giorno Chan to your group",
                     ...
                     [
                         InlineKeyboardButton(
                             text="🚨 Support 🚨",
                             url=f"https://t.me/the_cult"),
                         InlineKeyboardButton(
                             text="Meme Channel",
                             url="https://t.me/cultmemebase")
                    ], 
                     [
                         InlineKeyboardButton(
                             text="🔔 Off Topic 🔔",
                             url="https://t.me/WeebsGC")
                    ], 
                     [
                         InlineKeyboardButton(
                             text="📳 Chat Group 📳",
                             url="https://t.me/The_Cult")
                    ]]))
        ...
        update.effective_message.reply_video(
                KURUMI_IMG, caption=f"I, Giorno Giovanna, Have A Dream")
...
def main():
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendMessage(f"@{SUPPORT_CHAT}", "[Kore ga requiem da!](https://telegra.ph/file/454c6feefed99723d5add.mp4)", parse_mode=ParseMode.MARKDOWN) 
        except Unauthorized:
            LOGGER.warning(
